...
# frames to differentiate how to use label and user reviews label
how_to_use_label_frame = Frame(root, width=700, height=100)
# border width and relief to create a black edging
how_to_use_label_frame.configure(borderwidth=2, relief=GROOVE)
...
# border width and relief to create a black edging
user_reviews_label_frame.configure(borderwidth=2, relief=GROOVE)
# sticky north, south, east, west to ensure it hits all sides
...
# frames for how to use instructions and user reviews content
how_to_use_instructions_frame = Frame(root, width=700, height=500)
how_to_use_instructions_frame.configure(borderwidth=2, relief=GROOVE)
how_to_use_instructions_frame.grid(row=3, column=0, sticky=NSEW)

user_reviews_content_frame = Frame(root, width=700, height=500)
user_reviews_content_frame.configure(borderwidth=2, relief=GROOVE)
user_reviews_content_frame.grid(row=3, column=1, sticky=NSEW)
